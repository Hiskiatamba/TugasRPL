...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('Admin/data_barang') ?>" class="nav-link active ">
                        ...
                        <div class="card-body">
                            <div class="card">
                                <div class="card-header">
                                    <button class="btn btn-primary" id="tomboltambahbarang"><i class="fas fa-plus"></i>
                                        Tambah
                                        Data</button>
                                ...
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table id="databarang" class="table table-bordered table-hover" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>Kode Barang</th>
    ...
    function hapus(kode_barang) {
        Swal.fire({
            title: 'Hapus',
            text: `Apakah Kamu Yakin Ingin Menghapus Data Barang Dengan Kode Barang ${kode_barang} ?`,
            icon: 'warning',
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: '<?= base_url('Barang/hapusdatabarang') ?>',
                    data: {
                        kode_barang: kode_barang
                    },
                    dataType: 'json',
