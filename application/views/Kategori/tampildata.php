...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('Admin/data_kategori') ?>" class="nav-link active">
                        ...
                        <div class="card-body">
                            <div class="card">
                                <div class="card-header">
                                    <button class="btn btn-primary" id="tomboltambahkategori"><i
    ...
    function tampildatakategori() {
        table = $('#datakategori').DataTable({
            ...
            "ajax": {
                "url": "<?= site_url('Kategori/ambildata') ?>",
                "type": "POST"
            },
    ...
    function hapus(kode_kategori) {
        Swal.fire({
            title: 'Hapus',
            text: `Apakah Kamu Yakin Ingin Menghapus Data Kategori Dengan Kode Kategori ${kode_kategori} ?`,
            icon: 'warning',
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: '<?= base_url('Kategori/hapusdatakategori') ?>',
                    data: {
                        kode_kategori: kode_kategori
                    },
                    dataType: 'json',
