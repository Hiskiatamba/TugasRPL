...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('Admin/data_barang_masuk') ?>" class="nav-link active">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('Admin/data_barang_keluar') ?>" class="nav-link">
                        ...
                        <div class="card-body">
                            <div class="card">
                                <div class="card-header">
                                    <button class="btn btn-primary" id="tomboltambahbarangmasuk"><i
                                            class="fas fa-plus"></i>
                                        Tambah
                                        Data</button>
                                ...
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table id="databarangmasuk" class="table table-bordered table-hover"
                                        style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>No</th>
    ...
    <script>
    function tampildatabarangmasuk() {
        table = $('#databarangmasuk').DataTable({
            ...
            "ajax": {
                "url": "<?= site_url('Barangmasuk/ambildata') ?>",
                "type": "POST"
            },
    ...
    $(document).ready(function() {
        ...
        $('#tomboltambahbarangmasuk').click(function() {
            $.ajax({
                url: '<?= base_url('Barangmasuk/formtambah') ?>',
                dataType: 'json',
    ...
    function hapus(id_bm) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: '<?= base_url('Barangmasuk/hapusdatabarangmasuk') ?>',
                    data: {
                        id_bm: id_bm
                    },
                    dataType: 'json',
