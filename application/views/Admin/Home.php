                    ...
                    <div class="row">
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-info">
                                ...
                                <a href="<?= base_url('Admin/data_barang') ?>" class="small-box-footer">Selengkapnya <i
                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-success">
                                ...
                                <a href="<?= base_url('Admin/data_barang_masuk') ?>"
                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-warning">
                                ...
                                <a href="<?= base_url('Admin/data_barang_keluar') ?>"
                                    class="small-box-footer">Selengkapnya <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-danger">
                                ...
                                <a href="<?= base_url('Admin/data_kategori') ?>" class="small-box-footer">Selengkapnya
