<div class="modal fade" id="modaltambah">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <?= form_open('Barangkeluar/simpandatabarangkeluar',['class' => 'formtambahbarangkeluar']) ?>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="tanggal_keluar">Tanggal Barang Masuk</label>
                ...
                <div class="form-group">
                    <label for="jumlah_bk">Jumlah Barang Masuk</label>
                    <input type="text" class="form-control" id="jumlah_bk" name="jumlah_bk"
...
$(document).ready(function() {
    ...
    $('.formtambahbarangkeluar').submit(function(e) {
        $.ajax({
            type: "POST",
